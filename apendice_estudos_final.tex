...
A Tabela \ref{tab:all_studies} apresenta a listagem completa dos 82 estudos primários incluídos nesta revisão sistemática.

% Configuração V5: Booktabs Clean + Largura Total (17.5cm)
\scriptsize
...
\begin{longtable}{L{0.6cm} L{2.2cm} C{0.8cm} L{2.8cm} L{8.5cm}}
\caption{Lista Completa dos Estudos Primários Selecionados (S1-S82)} \label{tab:all_studies} \\
\toprule
\textbf{ID} & \textbf{Ref.} & \textbf{Ano} & \textbf{Categoria} & \textbf{Foco/Contribuição Principal} \\
\midrule
\endfirsthead
