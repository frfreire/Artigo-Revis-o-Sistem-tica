% ============================================================================
% CABEÇALHO CORRIGIDO DA TABELA DO APÊNDICE
% ============================================================================
...
A Tabela \ref{tab:all_studies} apresenta a listagem completa dos \textbf{132 estudos primários} incluídos nesta revisão sistemática, classificados por ano e categoria tecnológica.
...
\caption{Lista Completa dos Estudos Primários Selecionados (S1-S132)} \label{tab:all_studies} \\
\toprule
...
S3 & \cite{habibzadeh2025} & 2025 & LLM/SOC & LLMs em Operações de Segurança \\ 
S4 & \cite{mohale2024systematic} & 2025 & XAI/IDS & Review sistemático de XAI em IDS \\ 
...
S7 & \cite{kolicic2024inherently} & 2024 & Online Learning & Modelos interpretáveis online \\ 
...
S35 & \cite{Zhao2022} & 2022 & GAN & Detecção de Intrusão \\ 
...
S78 & \cite{tramer2017ensemble} & 2018 & Adversarial & Ensemble Adversarial \\ 
...
S83 & \cite{xu2025llm} & 2025 & LLM & Survey abrangente de LLMs em ciberseg. \\ 
S84 & \cite{das2025security} & 2025 & LLM/Privacy & Desafios de segurança e privacidade \\ 
S85 & \cite{venkateswarlu2025privacy} & 2025 & Federated/XAI & FL com GNN e XAI \\ 
S86 & \cite{balaji2025explainable} & 2025 & GNN/LLM & Detecção com GNN e LLMs \\ 
S87 & \cite{ahi2025llms} & 2025 & GenAI/Dual-Use & Riscos duais de LLMs \\ 
S88 & \cite{balakrishnan2025enhanced} & 2025 & XAI/GenAI & IDS com DL, XAI e GenAI \\ 
S89 & \cite{sikder2025efficient} & 2025 & LLM/Smart Contracts & Detecção de vulnerabilidades \\ 
S90 & \cite{zhou2025llm} & 2025 & LLM & Review de detecção de vulnerabilidades \\ 
S91 & \cite{nguyen2025safe} & 2025 & LLM & Framework SAFE para vulnerabilidades \\ 
S92 & \cite{sheng2025llms} & 2025 & LLM & Survey de técnicas de detecção \\ 
S93 & \cite{shin2025semantic} & 2025 & GNN/Malware & Fusão semântica para malware \\ 
S94 & \cite{alasmari2025phishing} & 2025 & LLM/XAI & Detecção de phishing com CNN-LSTM \\ 
S95 & \cite{elgarhy2025robustness} & 2025 & XAI/Adversarial & Robustez de XAI contra ataques \\ 
S96 & \cite{chen2025chatgpt} & 2025 & LLM & ChatGPT em smart contracts \\ 
S97 & \cite{ileana2025intelligent} & 2025 & XAI/IoT & IDS explicável para IoT \\ 
S98 & \cite{wang2025securemind} & 2025 & LLM & Detecção de bugs de memória \\ 
S99 & \cite{alhashimi2025exploring} & 2025 & GenAI/SDLC & IA Generativa no ciclo SDLC \\ 
S100 & \cite{luo2025federated} & 2025 & Federated/LLM & FL com LLMs para edge cloud \\ 
S101 & \cite{kim2025payload} & 2025 & LLM & Detecção com análise de payload \\ 
S102 & \cite{prajwalasimha2025federated} & 2025 & Federated/Zero-Day & FL adversarial para IoT \\ 
S103 & \cite{mia2025federated} & 2025 & Federated & DL federado para redes \\ 
S104 & \cite{gyawali2025augmenting} & 2025 & XAI/LLM & XAI com LLMs para ITS \\ 
S105 & \cite{donato2025benchmarking} & 2025 & LLM/Adversarial & Robustez de LLMs \\ 
S106 & \cite{rajee2025explainable} & 2025 & XAI/Adversarial & Detecção de ataques adversariais \\ 
S107 & \cite{dou2025scalable} & 2025 & GNN & Sistema escalável de vulnerabilidades \\ 
S108 & \cite{peng2025etrace} & 2025 & LLM & Análise de smart contracts \\ 
S109 & \cite{li2025pvdetector} & 2025 & GNN & Detecção pré-treinada \\ 
S110 & \cite{chen2025jps} & 2025 & LLM/Adversarial & Jailbreak de LLMs multimodais \\ 
S111 & \cite{wu2025enhancing} & 2025 & GNN & Completude semântica interprocedural \\ 
S112 & \cite{ghazal2024cybersecurity} & 2024 & LLM/XAI & Revolução via LLMs e XAI \\ 
S113 & \cite{hasanov2024application} & 2024 & LLM & Aplicações de LLMs \\ 
S114 & \cite{chen2024using} & 2024 & XAI/Adversarial & Técnicas de explicabilidade \\ 
S115 & \cite{oki2024evaluation} & 2024 & Federated/XAI & FL com XAI para IDS \\ 
S116 & \cite{hou2024adversarial} & 2024 & GNN/Adversarial & Robustez adversarial em GNN \\ 
S117 & \cite{chen2024rmcbench} & 2024 & LLM & Benchmark de resistência \\ 
S118 & \cite{zhang2024prompt} & 2024 & LLM & Detecção com ChatGPT \\ 
S119 & \cite{reti2024honeytoken} & 2024 & LLM & Geração de honeytokens \\ 
S120 & \cite{thompson2024entity} & 2024 & RL & RL para defesa autônoma \\ 
S121 & \cite{skopik2024nlp} & 2024 & NLP & NLP para análise OSINT \\ 
S122 & \cite{sruthi2024enhancing} & 2024 & XAI/Zero-Day & XAI para zero-day \\ 
S123 & \cite{chaudhari2025deep} & 2025 & Deep Learning & Aplicações em cibersegurança \\ 
S124 & \cite{ankalaki2025cyber} & 2025 & GenAI & Predição de ataques com GenAI \\ 
S125 & \cite{asaduzzaman2022adversarial} & 2022 & Adversarial & Abordagem adversarial híbrida \\ 
S126 & \cite{mohamed2024artificial} & 2024 & AI/APT & IA para vulnerabilidades APT \\ 
S127 & \cite{alnahdi2024towards} & 2024 & XAI/LLM & Framework de transparência \\ 
S128 & \cite{badawy2025ai} & 2025 & AI Review & Review técnico de IDS \\ 
S129 & \cite{zhang2023enhancement} & 2023 & GNN/Robustness & Robustez de GNN \\ 
S130 & \cite{walia2025ai} & 2025 & AI/Cloud & IA para infraestrutura cloud \\ 
S131 & \cite{liu2025assessing} & 2025 & LLM/Robustness & Avaliação de robustez \\ 
S132 & \cite{sangelia2025breaking} & 2025 & AI/Fraud & Detecção de fraudes \\ 
